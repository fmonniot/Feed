...
import eu.monniot.feed.store.RoomCategoryStore
...
class FeedApplication : Application() {
    ...
    override fun onCreate() {
        ...
        val categoryStore = RoomCategoryStore(database, database.categoryDao())
        val syncEngine = SyncEngine(feedApi, articleStore)
        repository = SharedFeedRepository(feedApi, articleStore, syncEngine, feedStore, categoryStore)
